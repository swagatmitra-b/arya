...
//   yes(
//     "replaceCol",
//     subject.replaceCol(1, new Float64Array([4, 0])),
//     new Matrix2D([
//       [1, 4],
//       [7, 0],
//     ])
...
//   yes(
//     "replaceRow",
//     subject.replaceRow(1, new Float64Array([6, 9])),
//     new Matrix2D([
//       [1, 3],
//       [6, 9],
//     ])
...
//   yes(
//     "replaceColIn",
//     subject.replaceColIn(1, new Float64Array([4, 0])),
//     subject
//   );
//   yes(
//     "replaceRowIn",
//     subject.replaceRowIn(1, new Float64Array([2, 2])),
//     subject
//   );
//   yes(
//     "add",
